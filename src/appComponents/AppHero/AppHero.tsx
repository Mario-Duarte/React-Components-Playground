            ...
            <HeroInner>
                ...
                <Content>
                    ...
                    <Typography color={colors.cityLights} align='center' lineHeight={1.8} fontWeight={500}>
                        ...
                        To start open the project in your favorite code editor and read thru the <span>Readme.md</span> file to find out more about <a href='https://github.com/Mario-Duarte/Storybooks-playground' target={"_blank"} rel='noreferrer'>this project</a>. To start StoryBooks you can run <span>yarn storybook</span> and <span>yarn test</span> to run the test scripts.<br/>
